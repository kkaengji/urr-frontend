...
export const mockArtists: MockArtist[] = [
  ...
  },
  {
    ...
    bannerImageUrl: "/artists/4/banner.jpeg",
  ...
  },
  {
    ...
    bannerImageUrl: "/artists/8/banner.jpeg",
  ...
  },
  {
    id: 15,
    name: "NMIXX",
    profileImageUrl: "/artists/15/profile.jpg",
    bannerImageUrl: "/artists/15/banner.png",
    bio: "2022년 JYP엔터테인먼트에서 데뷔한 6인조 걸그룹. 장르를 넘나드는 독특한 음악성과 강렬한 퍼포먼스로 주목받는 4세대 K-POP 아이콘.",
  ...
  },
  {
    id: 16,
    name: "10cm",
    profileImageUrl: "/artists/16/profile.jpg",
    bannerImageUrl: "/artists/16/banner.jpeg",
    bio: "2010년 데뷔한 싱어송라이터 권정열의 솔로 프로젝트. 감성적인 가사와 독보적인 음색으로 대중적 사랑을 받는 인디팝 아티스트.",
    followerCount: 1_200_000,
    category: "solo",
    extendedInfo: {
      artistId: "16",
      debutDate: "2010.12.16",
      agency: "Mirrorball Music",
      genres: ["Indie Pop", "Folk", "K-Pop"],
    },
  },
  {
    id: 17,
    name: "SEVENTEEN",
    profileImageUrl: "/artists/17/다운로드.jpg",
    bannerImageUrl: "/artists/17/banner.jpg",
    bio: "2015년 PLEDIS엔터테인먼트에서 데뷔한 13인조 보이그룹. 직접 작사·작곡·안무를 담당하는 '자체제작돌'로 전 세계 팬덤 '캐럿'을 보유한 글로벌 K-POP 아이콘.",
